...
class LettersData {
  static final List<Letter> _letters = [
    const Letter(
      ...
      phoneme: 'ah',
      syllables: ['a'],
      exampleWords: ['árbol', 'avión', 'agua', 'abeja'],
      ...
      activities: [
        Activity(
          id: 'a_pronunciation',
          name: 'Pronunciación de A',
          description: 'Aprende a pronunciar la letra A',
          type: ActivityType.pronunciation,
          difficulty: DifficultyLevel.beginner,
          instruction: 'Escucha y repite el sonido de la letra A',
        ),
        Activity(
          id: 'a_words',
          name: 'Palabras con A',
          description: 'Descubre palabras que empiezan con A',
          type: ActivityType.wordReading,
          difficulty: DifficultyLevel.beginner,
          instruction: 'Toca las imágenes y escucha las palabras',
        ),
      ],
    ),
    Letter(
